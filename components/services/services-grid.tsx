      ...
      <div className="container mx-auto px-6 sm:px-8 lg:px-12">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto leading-relaxed">
            We deliver comprehensive IT solutions that drive innovation, enhance security, 
            ...
            return (
              ...
              >
                <CardContent className="p-6">
                  ...
                  <h3 className="text-xl font-bold text-tech-navy mb-3 group-hover:text-primary transition-colors">
                    {service.title}
                  </h3>
