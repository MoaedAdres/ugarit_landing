...
function AnimatedMetric({ value, label }: { value: string; label: string }) {
  ...
  return (
    <div ref={ref} className="text-center">
      <div className="text-3xl md:text-4xl font-heading font-black text-primary mb-2">{displayValue}</div>
    ...
    <section className="py-20 bg-primary text-primary-foreground">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="font-heading font-bold text-3xl md:text-4xl mb-4 text-balance">Measurable Results</h2>
