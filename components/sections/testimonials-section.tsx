...
const mockTestimonials = [
	...
	},
	{
		...
		quote: "The team's attention to detail and commitment to excellence is unmatched. They delivered our project on time and under budget.",
		rating: 5,
	...
	},
	{
		...
		role: "CTO",
		company: "RetailTech",
		quote: "Ugarit's cloud architecture design has scaled beautifully with our business growth. Highly recommend their services.",
		rating: 5,
							...
							<SwiperSlide key={testimonial.id}>
								<Card className="group hover:shadow-glow transition-all duration-300 border-0 gradient-card hover:-translate-y-2 h-full flex flex-col">
									<CardContent className="p-6 h-full flex flex-col">
										...
										<blockquote className="text-muted-foreground leading-relaxed mb-6 text-sm flex-grow">"{testimonial.quote}"</blockquote>
