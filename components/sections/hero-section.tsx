			...
			<div className="relative z-10 container mx-auto px-4 text-center text-white">
				<div className="max-w-4xl mx-auto">
					<h1 className="text-5xl text-secondary-9 md:text-6xl lg:text-7xl font-bold mb-6 leading-tight">
						Build. Scale. <span className="text-primary-foreground">Secure.</span>
					</h1>
					<p className="text-xl md:text-2xl text-secondary-800 mb-8 leading-relaxed max-w-3xl mx-auto">
						Transform your business with cutting-edge IT solutions, cloud services, and digital transformation expertise from industry
						leaders.
					</p>
