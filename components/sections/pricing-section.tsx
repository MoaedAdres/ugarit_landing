...
const pricingPlans = [
	{
		...
		period: "month",
		popular: false,
		features: ["Cloud Infrastructure Setup", "Basic Security Monitoring", "Email Support", "Monthly Health Checks", "Backup & Recovery"],
		cta: "Get Started",
	},
	{
		name: "Professional",
		...
		<section className="py-16 bg-gradient-hero">
			<div className="container mx-auto px-6 sm:px-8 lg:px-12">
				...
				<div className="text-center mt-10">
					<p className="text-sm text-muted-foreground mb-4">Need a custom solution? We're here to help.</p>
