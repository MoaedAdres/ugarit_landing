					...
					{mockCaseStudies.map((study, index) => (
						...
						>
							...
							<CardContent className="p-6">
								<h3 className="text-lg font-bold text-tech-navy mb-2 group-hover:text-primary transition-colors">{study.title}</h3>
								<p className="text-xs text-muted-foreground mb-1 uppercase tracking-wide font-medium">{study.client}</p>
								<p className="text-sm text-muted-foreground mb-4 leading-relaxed">{study.summary}</p>
