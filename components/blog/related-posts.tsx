...
const relatedPosts = [
	{
		...
		excerpt: "Discover how to implement DevSecOps practices that enhance security without slowing down development.",
	...
	},
	{
		...
		excerpt: "Master the tools and techniques needed to effectively monitor Kubernetes clusters in production.",
		...
		<section className="py-20 bg-muted/30">
			<div className="container mx-auto px-4 sm:px-6 lg:px-8">
				<div className="text-center mb-16">
					<h2 className="font-heading font-bold text-3xl text-foreground mb-4 text-balance">Related Articles</h2>
					<p className="text-xl text-muted-foreground text-pretty">Continue reading with these related insights</p>
				</div>
