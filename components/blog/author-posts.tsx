...
const authorPosts = [
	{
		...
		excerpt: "Learn the essential strategies and considerations for successfully migrating enterprise applications to the cloud.",
	...
	},
	{
		...
		excerpt: "Discover proven techniques to optimize your Azure spending while maintaining performance and reliability.",
		...
		<section className="py-20 bg-background">
			<div className="container mx-auto px-4 sm:px-6 lg:px-8">
				<div className="max-w-4xl mx-auto">
					<h2 className="font-heading font-bold text-3xl text-foreground mb-12 text-center">Latest Articles</h2>
						...
						{authorPosts.map((post, index) => (
							<Card key={post.slug} className="group hover:shadow-lg transition-all duration-300">
								<CardContent className="p-8">
									...
									<p className="text-muted-foreground mb-6 leading-relaxed text-pretty">{post.excerpt}</p>
