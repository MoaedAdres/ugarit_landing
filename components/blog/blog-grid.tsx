...
const blogPosts = [
	...
	},
	{
		...
		excerpt: "Explore how artificial intelligence is revolutionizing infrastructure management and optimization for modern enterprises.",
		cover_image: {
	...
	},
	{
		...
		excerpt: "Learn proven patterns and best practices for designing and implementing microservices architectures that scale.",
		cover_image: {
	...
	},
	{
		...
		excerpt: "A comprehensive guide to implementing zero trust security principles to protect your organization's digital assets.",
		cover_image: {
