        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
          ...
          <Card className="text-center">
            <CardContent className="p-8">
              ...
              <p className="text-muted-foreground">
                Receive feedback and hopefully welcome you to the team!
              </p>
            </CardContent>
          </Card>
        </div>
          ...
          <Card className="max-w-2xl mx-auto">
            <CardContent className="p-8">
              ...
              <p className="text-muted-foreground mb-6">
                We'd love to hear from you. Reach out to our HR team for any
                questions about careers, culture, or opportunities.
              </p>
              <Button asChild>
                <Link href="mailto:careers@ugarittech.com">
                  Contact HR Team
                </Link>
              </Button>
            </CardContent>
