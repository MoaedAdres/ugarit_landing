		...
		<section className="py-20 bg-background">
			<div className="container mx-auto px-4 sm:px-6 lg:px-8">
				<div className="text-center mb-16">
					<h2 className="font-heading font-bold text-3xl md:text-4xl text-foreground mb-4 text-balance">Application Process</h2>
					...
					<Card className="max-w-2xl mx-auto">
						<CardContent className="p-8">
							...
							<p className="text-muted-foreground mb-6">
								We'd love to hear from you. Reach out to our HR team for any questions about careers, culture, or opportunities.
							</p>
							<Button asChild>
