...
const perks = [
  ...
  },
  {
    ...
    description:
      "Professional development, certifications, and conference attendance",
  },
  {
    icon: Globe,
    title: "Global Impact",
    description:
      "Work on projects that make a difference for clients worldwide",
  },
  {
    icon: Coffee,
    title: "Great Perks",
    description:
      "Competitive salary, equity options, and amazing office amenities",
  },
];
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto text-pretty">
            We believe in creating an environment where our team can thrive and
            do their best work
          </p>
        </div>
