...
const jobs = [
	...
	},
	{
		...
		description: "Build and maintain CI/CD pipelines, automate infrastructure, and improve development workflows for our clients.",
	...
	},
	{
		...
		description: "Assess security postures, implement security frameworks, and help clients achieve compliance with industry standards.",
		...
		<section className="py-20 bg-muted/30">
			<div className="container mx-auto px-4 sm:px-6 lg:px-8">
				<div className="text-center mb-16">
					<h2 className="font-heading font-bold text-3xl md:text-4xl text-foreground mb-4 text-balance">Open Positions</h2>
