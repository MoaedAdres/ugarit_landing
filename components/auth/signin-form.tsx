...
import { useAuthTranslations, useErrorTranslations } from "@/hooks/use-translation";
			...
			<CardContent>
				<form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
					...
					<div className="space-y-2">
						...
						<Input id="email" type="email" placeholder={t("signin.email")} {...register("email")} disabled={isLoading} />
