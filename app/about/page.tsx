...
export const metadata: Metadata = generateSEOMetadata({
	...
	description:
		"Learn about Ugarit Technologies' mission, values, and expert team. Discover our journey in delivering enterprise IT solutions, cloud services, and DevOps consulting since 2020.",
	keywords: [
