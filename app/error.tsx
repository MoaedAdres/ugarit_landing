  ...
  return (
    <div className="mx-auto flex h-screen max-w-xs flex-col items-center justify-center gap-3">
      ...
      <div className="flex flex-wrap flex-row gap-3">
        {!!ErrorPage[key]?.actionTitle && (
          <Button onClick={reset}>{ErrorPage[key].actionTitle}</Button>
        )}
...
const ErrorPage = {
  Default: {
    description:
      "لسوء الحظ واجهنا خطأ، يمكنك محاولة إعادة تحميل الصفحة التي كنت تقوم بزيارتها.",
    title: "حدث خطأ ما!",
    actionTitle: "إعادة تحميل الصفحة",
  },
  ServerError: {
    description:
      "نواجه حالياً بعض المشكلات التقنية. يعمل فريقنا على حلها. يرجى المحاولة مرة أخرى لاحقاً.",
    title: "حدث خطأ ما!",
    actionTitle: null,
  },
};
